...
public class TicTacToeWaitingPlayerAdapter extends BaseAdapter {

	private Context _context = null;
	private List<IUser> _usersList;

	public TicTacToeWaitingPlayerAdapter(Context context, List<IUser> gameList) {
		_context = context;
		_usersList = gameList;
	}
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		textViewUserScore.setText(user.getScore(TicTacToeGame.class).toString());
